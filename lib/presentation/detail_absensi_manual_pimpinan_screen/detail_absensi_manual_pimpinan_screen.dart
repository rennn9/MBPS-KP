...
class DetailAbsensiManualPimpinanScreen extends StatefulWidget {
  ...
  @override
  State<DetailAbsensiManualPimpinanScreen> createState() =>
      _DetailAbsensiManualPimpinanScreenState();
}

class _DetailAbsensiManualPimpinanScreenState
    extends State<DetailAbsensiManualPimpinanScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String attendenceType =
        submissionData['submission_data']['attendance_type'] ?? '';
    String description =
