...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlineErrorContainerTL4 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(4.h),
        borderSide: BorderSide(
  ...
  static OutlineInputBorder get outlineErrorContainerTL41 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(4.h),
        borderSide: BorderSide(
          color: theme.colorScheme.errorContainer,
          width: 2,
  ...
  static OutlineInputBorder get outlineBlueF => OutlineInputBorder(
